...
pub(super) struct HostRunMetric {
    ...
    pub(super) lexical_candidates: usize,
    pub(super) structural_candidates: usize,
    pub(super) semantic_candidates: usize,
    ...
    pub(super) rerank_input_candidates: usize,
    pub(super) rerank_evaluated_candidates: usize,
    pub(super) rerank_selected_candidates: usize,
...
pub(super) struct HostEvaluationReport {
    ...
    pub(super) embedding_telemetry_source: &'static str,
