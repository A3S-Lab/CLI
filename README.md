...
- complete real-provider production qualification for release-backed OCI
  ...
  host restart, drain, exact removal, and no residual Runtime or PID state.
  Provider-process loss/rebinding and the cross-platform recovery matrix remain
  open;
