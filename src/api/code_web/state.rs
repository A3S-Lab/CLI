...
pub(in crate::api) struct CodeWebState {
    ...
    pub(in crate::api::code_web) workspace_retrieval_options:
        Option<crate::workspace_retrieval::WorkspaceRetrievalHost>,
...
impl CodeWebState {
    ...
    pub(in crate::api) fn with_workspace_retrieval(
        mut self,
        options: Option<crate::workspace_retrieval::WorkspaceRetrievalHost>,
    ) -> Self {
    ...
    pub(in crate::api::code_web) async fn workspace_services_for(
        ...
        self.workspace_backends
            .services_for(workspace, self.workspace_retrieval_options.as_ref())
            .await
    }
    ...
    pub(in crate::api::code_web) async fn workspace_manifest_snapshot_for(
        ...
        self.workspace_backends
            .manifest_snapshot_for(workspace, self.workspace_retrieval_options.as_ref())
            .await
    }
