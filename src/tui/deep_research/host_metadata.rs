...
mod legacy_projection {
    ...
    pub(in crate::tui) fn deep_research_sanitize_workflow_metadata(
    ...
    pub(in crate::tui) fn deep_research_workflow_output_digest(
    ...
    fn deep_research_accepted_evidence_payload_digest(
        value: &serde_json::Value,
    ) -> serde_json::Value {
    ...
    fn deep_research_compact_report_inquiry(
        value: &serde_json::Value,
    ...
    fn deep_research_compact_report_obligations(
        ...
        obligations
            ...
            .map(|obligation| {
                ...
                let criteria = deep_research_compact_string_array(
                    obligation.get("completion_criteria"),
                    3,
                    800,
                );
    ...
    fn deep_research_compact_contract_assessment(
        ...
        let mut assessment =
            serde_json::from_value::<a3s::research::ResearchContractAssessment>(value.clone())
                .ok()?;
    ...
    pub(in crate::tui) fn deep_research_collection_status(
        value: &serde_json::Value,
    ) -> &'static str {
    ...
    pub(in crate::tui) fn deep_research_result_has_completed_evidence(
    ...
    pub(in crate::tui) fn deep_research_workflow_metadata_digest(
        metadata: &serde_json::Value,
    ) -> serde_json::Value {
    ...
    pub(in crate::tui) fn deep_research_sanitize_parallel_task_values(
    ...
    pub(in crate::tui) fn deep_research_sanitize_parallel_task_object(
    ...
    pub(in crate::tui) fn deep_research_sanitize_parallel_result(
        result: &serde_json::Value,
        success: bool,
    ) -> serde_json::Value {
                ...
                .or_else(|| result.get("output"))
            {
                ...
                if let Some(structured) = parsed.and_then(|structured| {
                    ...
                    next.insert(
                        "structured_error".to_string(),
                        serde_json::Value::String(
                            "Delegated task returned no verified schema-shaped evidence."
                                .to_string(),
                        ),
                    );
                }
...
#[cfg(test)]
pub(super) use legacy_projection::*;
